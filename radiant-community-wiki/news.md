---
description: Monthly Radiant Chronicles
layout:
  width: default
  title:
    visible: true
...
### Gravity Protocol achieves mainnet trustless FT-to-BTC swaps
...
### GlyPhium resumes development and announces gaming expansion
...
### Radiant (RXD) officially launches on Gleec DEX!
...
### RXD ignites: 75% supply milestone hit with $232k daily volume!

Radiant (RXD) is surging with $232,000 in daily volume and a solid 9 percent gain this month.&#x20;

The network has hit a massive 75 percent distribution milestone with 15.8 billion coins now in circulation.&#x20;
...
### Radiant unstoppable: 45 active nodes power a global surge toward core 2.2.0!
...
### Radiant (RXD) market update: sideways trading
...
### RXD hovers at fractions of a cent as market watches volatility

Radiant’s native token, RXD, is trading around $0.00009 USD, just under one-hundredth of a cent.

While the price remains micro-level, daily volatility continues within a tight range, reflecting cautious sentiment.&#x20;

With a large circulating supply, even small percentage moves can shift market cap noticeably.&#x20;
...
{% hint style="info" icon="newspaper" %}
Issue 7 - December 2025 - YEAR-END SPECIAL EDITION
{% endhint %}
...
### The Radiant Army: mobilizing the global PR force & the crypto music revolution
...
### Simulation live: Defender of RXD

We invite you to answer the retro-signal. **Defender of RXD** is live - a chaotic training ground for the protocol wars.&#x20;

Blast through FUD and survive dynamic market physics in a simulation defined by absolute privacy: no databases, no tracking, just pure glory.&#x20;

The only thing standing between the chain and total centralization is a tiny pixelated ship.&#x20;
...
**Two secrets. One unlocked. One unknown.**
...
### Market watch: RXD under pressure

The crypto market stays cautious, with Bitcoin near US$108,000 and total value under US$3.7 trillion.&#x20;

Radiant (RXD) follows the trend at about **US$0.000018**, though new launches like WarWallet and the rumored R-Shield may soon lift momentum.

### Radiant Army mobilizes for multiplier week

Multiplier Week is here. Post, earn, and conquer - every mission brings 3×50 RXD, a shot at 20× spins on the Army Wheel, and a special prize for the top poster.&#x20;
...
Radiant (RXD) dropped sharply in September, falling from about **$0.000050** in mid-month to around **$0.00002465** by month’s end, a decline of roughly 50%.&#x20;

While the pullback has sparked concern, many see it as part of the wider crypto market’s volatility rather than a sign of weakness in Radiant itself.&#x20;

Supporters remain confident that the project’s proof-of-work foundation and growing ecosystem could help RXD recover if market conditions improve.

### Radiant's hashrate swings
...
Radiant (RXD) lit up the charts this past month with a blast-off of over 120%, jumping from its lows near **$0.000020** to touch **$0.000050** and holding strong around **$0.0000478**.&#x20;

The surge came with heavy trading volume and a wave of community excitement, turning RXD into one of the standout movers in the market.&#x20;
...
### Developers boost Radiant community
...
**Radiant had a ballistic breakout**

Radiant’s price action in August 2025 was nothing short of explosive, climbing from around **$0.000021** at the start of the month to nearly **$0.000032** by month’s end - a stunning gain of over 60%.&#x20;

This powerful move didn’t come out of nowhere; RXD had already begun flashing signals of strength in July, where steady accumulation and tightening price action hinted at a breakout on the horizon.

By August, that quiet momentum erupted into a late-month rally, with RXD smashing through resistance and peaking near **$0.0000364**, cementing its position as one of the standout movers of the summer.

### Radiant is now on LetsExchange!
...
By using the [referral link](https://letsexchange.io/exchange/usdt-to-rxd?ref_id=EiDWiy7xrxZTeAiy), supporters can also back the Radiant Foundation, fueling ongoing development while trading smart.&#x20;

With this milestone, Radiant shines brighter than ever, proving the future is Radiant.

### DragonBall’s mining in question
...
Radiant (RXD) trades near **$0.000021**, up 36% from March lows but well below its 2023 peak.
